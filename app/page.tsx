  ...
  return (
    ...
    >
      ...
      <motion.section
        ...
        transition={TRANSITION_SECTION}
      >
        <h3 className="mb-5 text-lg font-medium">Projekty</h3>
      ...
      <motion.section
        ...
        transition={TRANSITION_SECTION}
      >
        <h3 className="mb-5 text-lg font-medium">Doświadczenie</h3>
      ...
      <motion.section
        ...
        transition={TRANSITION_SECTION}
      >
        <h3 className="mb-5 text-lg font-medium">Kontakt</h3>
        <p className="mb-5 text-zinc-600 dark:text-zinc-400">
          Możesz skontaktować się ze mną na{' '}
